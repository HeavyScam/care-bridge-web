    ...
    <>
          ...
          <div className="flex list-none items-center gap-8 text-2xl">
            ...
            <button
              className={`rounded-lg ${
                isLogin ? "bg-[#fff] text-black border border-[#444BD3]" : "bg-[#444BD3] text-white"
      ...
      {isOpen && (
        ...
        >
          ...
          <ul className="cursor-pointer text-left text-2xl text-[#f7f7f7]">
            <li className="mb-3 mt-6 px-4">
              <Link href="#about">About Us</Link>
            </li>
